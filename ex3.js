...
function murderMistery(name,location){
var weapon ="";
var solved =false;

if (name=="Mr. Parkes" && location =="dining room"){
weapon = "Knife";
solved =true;

return name + " did it in the " + location + " with " + weapon

}else if (name=="Ms. Van Cleve" && location =="gallery"){
    weapon = "the trophy";
    solved =true;
    
    return name + " did it in the " + location + " with " + weapon
    
    }else if (name=="Mrs. Sparr" && location =="billiards room"){
        weapon = "the pool stick";
        solved =true;
        
        return name + " did it in the " + location + " with " + weapon
        
        } else if (name=="Mr. Kalehoff" && location =="ballroom"){
            weapon = "the poison";
            solved =true;
            ...
            return name + " did it in the " + location + " with " + weapon
                ...
                return "the murder was not found "
            }

}

console.log(murderMistery("Mr. Parkes", "dining room"));
console.log(murderMistery("Ms. Van Cleve", "gallery"));
console.log(murderMistery("Mrs. Sparr", "billiards room"));
console.log(murderMistery("Mr. Kalehoff", "ballroom"));
console.log(murderMistery("f", "m"));